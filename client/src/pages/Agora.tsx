...
const AGENTS: Agent[] = [
  {
    ...
    position: { x: 250, y: 160 }, // Left side - properly centered
    status: 'active',
  ...
  },
  {
    ...
    position: { x: 300, y: 120 }, // Top center - true center
    status: 'processing',
  ...
  },
  {
    ...
    position: { x: 450, y: 160 }, // Right side - centered
    status: 'active',
  ...
  },
  {
    ...
    position: { x: 200, y: 200 }, // Left-center - centered properly
    status: 'idle',
  ...
  },
  {
    ...
    position: { x: 400, y: 190 }, // Center-right - centered
    status: 'active',
  ...
  },
  {
    ...
    position: { x: 480, y: 240 }, // Right-center - centered
    status: 'processing',
  ...
  },
  {
    ...
    position: { x: 170, y: 280 }, // Left-bottom - centered
    status: 'active',
  ...
  },
  {
    ...
    position: { x: 280, y: 300 }, // Bottom-left-center - centered
    status: 'processing',
  ...
  },
  {
    ...
    position: { x: 420, y: 290 }, // Right-bottom - centered
    status: 'active',
  ...
  },
  {
    ...
    position: { x: 350, y: 320 }, // Bottom center - true center
    status: 'active',
