...
export default function Agora() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-green-50/20 relative overflow-hidden">
      ...
      <div className="absolute top-48 left-4 w-96 h-96 pointer-events-none z-30">
      ...
      <div className="absolute top-48 right-16 w-72 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 p-4 z-30">
