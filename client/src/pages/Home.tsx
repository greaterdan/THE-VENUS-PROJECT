  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden -mt-16 pt-16">
        ...
        <div 
          className={`absolute -top-16 left-0 right-0 bottom-0 bg-gray-100 transition-opacity duration-4000 ease-out delay-200 ${
            showContent ? 'opacity-100' : 'opacity-0'
          }`}
        ></div>
        <div 
          className={`absolute -top-16 left-0 right-0 bottom-0 transition-opacity duration-4000 ease-out delay-600 ${
            showContent ? 'opacity-100' : 'opacity-0'
          }`}
          style={{
        ...
        ></div>
        <div 
          className={`absolute -top-16 left-0 right-0 bottom-0 bg-white bg-opacity-10 transition-opacity duration-4000 ease-out delay-1000 ${
            showContent ? 'opacity-100' : 'opacity-0'
          }`}
        ></div>
        ...
        <div 
          className={`absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-white via-white/80 to-transparent pointer-events-none z-25 transition-opacity duration-4000 ease-out delay-2000 ${
            showContent ? 'opacity-100' : 'opacity-0'
          }`}
          style={{
        ...
        {/* Scroll indicator */}
        <div 
          className={`absolute bottom-1 left-1/2 transform -translate-x-1/2 text-black animate-bounce z-20 transition-opacity duration-4000 ease-out delay-3000 ${
            showContent ? 'opacity-100' : 'opacity-0'
          }`}
          style={{
      ...
      {/* Transition section */}
      <div 
        className={`min-h-screen bg-white p-8 relative z-30 transition-all duration-4000 ease-out delay-1500 ${
      ...
      <div 
        className={`bg-white py-16 transition-all duration-4000 ease-out delay-3000 ${
          showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
      >
